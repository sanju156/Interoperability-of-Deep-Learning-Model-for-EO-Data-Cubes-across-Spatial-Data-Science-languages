...
# --- Install CUDA 11.8 Runtime + cuDNN ---
...
# --- Install GPU-enabled torch (cu118) with pinned version ---
...
# --- (Optional) Install other useful R packages ---
...
# Force install hdf5r into system-wide library
